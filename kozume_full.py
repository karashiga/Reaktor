...
def jovan():
    ...
    {adrkz} 
         ...
         ╚═╝  ╚═╝ ╚═════╝ ╚══════╝ ╚═════╝ ╚═╝     ╚═╝╚══════╝
     {blue}───────────────────────────────────────────────────────────────\033[0m
     {blue}OWNER     {yellow}: {green}KOZUME
     {blue}VERSION   {yellow}: {green}KOZUME {red}V5 {yellow}/ {adrkz}CELLPHONE VERSION
     {blue}FACEBOOK  {yellow}: {green}https://www.facebook.com/profile.php?id=100078043222260
